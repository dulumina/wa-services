...
export function MainWrapper({ children }: { children: React.ReactNode }) {
  ...
  // Handle server-side and initial client-side render (must match)
  if (!mounted) {
    if (isAuthPage) return <main className="main-content" style={{ marginLeft: 0, padding: 0 }}>{children}</main>;
    return (
